...
class EditableComponents extends Parent {
    ...
    registerSchema(Vue){
        ...
        <q-card-section horizontal>
            ...
            <q-card-section class='col-4 full-height'>
                <div style = 'height: 70vh;'>
                    ...
                    /> -->
                    <editor v-model="Editor.value" @init="editorInit" lang="html" theme="chrome" width="100%" height="100%"></editor>
                </div>
                <q-btn
        ...
        `;
        let editor = typeof window !== 'undefined' ? require('vue2-ace-editor') : {};
        Vue.component('SchemaEditableComponents', {
            ...
            methods: {
                ...
                restore: async function () {
                    if (!this.CurrentComponent) return;
                    self[this.CurrentComponent] = null;
                    let res = await self.save();
                },
